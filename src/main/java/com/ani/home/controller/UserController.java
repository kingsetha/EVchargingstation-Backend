...
public class UserController {
    ...
    public UserController(UserServiceImpl service, AdminServiceImpl aservice,
			StationAdminServiceImpl stationAdminServiceImpl, PaymentServiceImpl paymentServiceImpl,
